...
<body>
  ...
  .chapter-content .n-msg-y * { color: #5C5230; }
  ...
  .chapter-content .n-email::before { content: '✉️'; position: absolute; left: 14px; top: 13px; font-size: 14px; }
  ...
  .chapter-content .n-status::before { content: none; display: inline-block; font-size: 11px; color: #5E9C76; margin-right: 8px; }
...
async function estimateEpisodePages(ep, pubSet) {
  ...
  try {
    ...
    const styleTag =
      ...
      '.n-email-body::before { content:none; display:inline-block; font-size:14px; margin-right:8px; }' +
      ...
      '.n-doc::before { content:none; display:inline-block; font-size:14px; margin-right:8px; }' +
      ...
      '.n-status::before { content:none; display:inline-block; font-size:11px; margin-right:8px; }' +
      '.n-status + .n-status { margin-top:0; padding-top:4px; padding-left:18px; }' +
      ...
      '.n-memo::before { content:none; display:inline-block; font-size:14px; margin-right:8px; }' +
...
function _buildTreeSpreadHtml(leftDesc, rightDesc, pubSet, p, pageDescriptors) {
  ...
  return (
    ...
    '.n-email::before { content:"✉️"; position:absolute; left:14px; top:13px; font-size:14px; }' +
    ...
    '.n-doc::before { content:none; display:inline-block; font-size:14px; color:#95AED0; margin-right:8px; }' +
    ...
    '.n-status::before { content:none; display:inline-block; font-size:11px; color:#5E9C76; margin-right:8px; }' +
    ...
    '.n-status + .n-status { padding-left:18px; }' +
    '.n-log:not(:has(+ .n-log)), .n-log + .n-log:not(:has(+ .n-log)),' +
    '.n-alert:not(:has(+ .n-alert)), .n-alert + .n-alert:not(:has(+ .n-alert)),' +
    '.n-record:not(:has(+ .n-record)), .n-record + .n-record:not(:has(+ .n-record)),' +
...
<style>
  ...
  .chapter-content .n-email-body::before { content: none; display: inline-block; font-size: 14px; margin-right: 8px; }
  .chapter-content .n-doc {
    display: block; font-family: 'Pretendard', 'Noto Sans KR', sans-serif; font-size: 0.95em; background: #FAFAFA;
    border-left: 4px solid #95AED0; line-height: 1.7; text-indent: 0 !important; color: #222;
    border-top-left-radius: 6px; border-top-right-radius: 6px; padding: 16px 20px 4px 20px; margin: 20px 0 0 0;
  }
  .chapter-content .n-doc::before { content: none; display: inline-block; font-size: 14px; color: #95AED0; margin-right: 8px; }
  .chapter-content .n-noti {
    display: block; max-width: 70%; margin: 16px 0; background: #FFF9C4; border-radius: 18px 18px 18px 2px;
    padding: 12px 18px 12px 38px; font-size: 0.95em; font-family: 'Pretendard', 'Noto Sans KR', sans-serif;
    line-height: 1.6; text-align: left; text-indent: 0 !important; box-shadow: 0 1px 2px rgba(0,0,0,.03);
  ...
  .chapter-content .n-memo::before { content: none; display: inline-block; font-size: 14px; margin-right: 8px; }
  .chapter-content blockquote {
    display: block; background: #F1F3F5; border-radius: 12px 12px 12px 0; padding: 16px 20px;
    margin: 24px 0; font-family: 'Pretendard', 'Noto Sans KR', sans-serif; font-size: 0.95em;
    line-height: 1.6; text-indent: 0 !important; color: #17141F;
...
let ebookEpIndex = 0;
// attachEbookSelectionHandler가 페이지 이동마다 재호출되므로, 이전 selectionchange
// 리스너를 추적해뒀다가 재등록 전에 제거한다 — 안 그러면 document에 리스너가
// 계속 쌓인다(오래 읽을수록 누적).
let ebookSelectionChangeHandler = null;
...
function attachEbookSelectionHandler(ep) {
  ...
  if (ebookSelectionChangeHandler) {
    document.removeEventListener('selectionchange', ebookSelectionChangeHandler);
  }
  ebookSelectionChangeHandler = () => {
  ...
  document.addEventListener('selectionchange', ebookSelectionChangeHandler);
}
